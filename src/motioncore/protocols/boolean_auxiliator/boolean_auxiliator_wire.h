...
class Wire : public motion::BooleanWire {
 ...
 public:
  ...
  MpcProtocol GetProtocol() const final { return MpcProtocol::kBooleanAuxiliator; }
...
using WirePointer = std::shared_ptr<boolean_auxiliator::Wire>;

class BitMatrixWire final : public boolean_auxiliator::Wire {
  using Base = boolean_auxiliator::Wire;
    public:
